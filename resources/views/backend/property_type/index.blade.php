            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{   route('admin.property_type.create')   }}"  class="btn btn-primary mb-2"><i
                            ...
                            <table class="table add-rows">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                            <a href="{{   route('admin.property_type.edit',$property_type->id) }}"> <i class="feather icon-edit font-medium-5"></i> EDIT</a>
                                         |  <a href=""
                                                onclick="if(confirm('Are You sure you want to delete this')){event.preventDefault();document.getElementById('delete-form-{{ $property_type->id }}').submit();}else{event.preventDefault();}">
                                                <i class="feather icon-trash  font-medium-5"> </i>DELETE</a>
                                            <form id="delete-form-{{ $property_type->id }}" method="post" action="{{ route('admin.property_type.destroy',$property_type->id) }}">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                            </form>
